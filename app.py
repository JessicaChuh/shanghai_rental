...
def main():
    # User inputs
    # Number inputs
    size = st.number_input("Size",min_value=0, max_value=600, step=1)
    n_bedrooms = st.number_input("Number of Bedrooms",min_value=0, max_value=10, step=1)
    n_bathrooms = st.number_input("Number of Bathrooms",min_value=0, max_value=10, step=1)
    floor = st.number_input("Floor",min_value=1, max_value=50, step=1)
